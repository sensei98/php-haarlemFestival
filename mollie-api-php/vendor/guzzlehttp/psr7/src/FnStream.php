 ...
 * @final
 */
class FnStream implements \_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
