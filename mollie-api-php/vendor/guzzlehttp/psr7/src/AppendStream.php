 ...
 * @final
 */
class AppendStream implements \_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \_PhpScoperf97ee63196d1\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
