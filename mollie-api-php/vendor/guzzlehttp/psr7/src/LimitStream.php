 ...
 * @final
 */
class LimitStream implements \_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
