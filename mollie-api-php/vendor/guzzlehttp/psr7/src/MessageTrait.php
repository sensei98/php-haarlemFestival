...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \_PhpScoperf97ee63196d1\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }
