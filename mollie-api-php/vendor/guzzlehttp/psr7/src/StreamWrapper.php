...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoperf97ee63196d1\Psr\Http\Message\StreamInterface $stream)
    {
