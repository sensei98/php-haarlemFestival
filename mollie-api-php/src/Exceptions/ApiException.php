...
class ApiException extends \Exception
{
     ...
     */
    public function __construct($message = "", $code = 0, $field = null, \_PhpScoperf97ee63196d1\Psr\Http\Message\RequestInterface $request = null, \_PhpScoperf97ee63196d1\Psr\Http\Message\ResponseInterface $response = null, $previous = null)
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public static function createFromResponse(\_PhpScoperf97ee63196d1\Psr\Http\Message\ResponseInterface $response, \_PhpScoperf97ee63196d1\Psr\Http\Message\RequestInterface $request = null, $previous = null)
    {
