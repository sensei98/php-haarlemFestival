...
use _PhpScoperf97ee63196d1\Composer\CaBundle\CaBundle;
use _PhpScoperf97ee63196d1\GuzzleHttp\Client;
use _PhpScoperf97ee63196d1\GuzzleHttp\ClientInterface;
...
use _PhpScoperf97ee63196d1\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoperf97ee63196d1\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient;
        if (!$this->httpClient) {
            $retryMiddlewareFactory = new \Mollie\Api\Guzzle\RetryMiddlewareFactory();
            $handlerStack = \_PhpScoperf97ee63196d1\GuzzleHttp\HandlerStack::create();
            $handlerStack->push($retryMiddlewareFactory->retry());
            $this->httpClient = new \_PhpScoperf97ee63196d1\GuzzleHttp\Client([\_PhpScoperf97ee63196d1\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperf97ee63196d1\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperf97ee63196d1\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT, \_PhpScoperf97ee63196d1\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::CONNECT_TIMEOUT, 'handler' => $handlerStack]);
        }
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoperf97ee63196d1\GuzzleHttp\ClientInterface::MAJOR_VERSION);
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoperf97ee63196d1\GuzzleHttp\ClientInterface::VERSION);
        }
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoperf97ee63196d1\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperf97ee63196d1\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperf97ee63196d1\Psr\Http\Message\ResponseInterface $response)
    {
